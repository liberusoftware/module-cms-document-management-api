...
[![Latest release](https://img.shields.io/github/v/release/liberusoftware/module-cms-document-management-api?sort=semver)](https://github.com/liberusoftware/module-cms-document-management-api/releases/latest) [![Tests](https://github.com/liberusoftware/module-cms-document-management-api/actions/workflows/tests.yml/badge.svg?branch=main)](https://github.com/liberusoftware/module-cms-document-management-api/actions/workflows/tests.yml)
...
```bash
composer require liberusoftware/module-cms-document-management-api
```
...
<a href="https://github.com/liberusoftware/module-cms-document-management-api/graphs/contributors">
  <img src="https://contrib.rocks/image?repo=liberusoftware/module-cms-document-management-api" alt="Contributors to liberusoftware/module-cms-document-management-api">
</a>

[View the full contributors graph](https://github.com/liberusoftware/module-cms-document-management-api/graphs/contributors).
